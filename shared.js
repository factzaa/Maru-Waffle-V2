...
// ===== สูตรกลาง: พยากรณ์สต๊อกรายตัว (ใช้ร่วมกันทุกหน้า + มารุ) =====
...
function maruAssistantMarkup(currentPage){
  ...
  return ''
   ...
   + '.maru-hi .mqc{width:100%;box-sizing:border-box;text-align:center;background:#fff;border:1.5px solid #ECE6D6;border-radius:13px;padding:11px 13px;font-size:13px;color:#1A1A1A;cursor:pointer;font-family:"Sarabun";font-weight:600;box-shadow:0 1px 3px rgba(120,86,0,.05);}'
